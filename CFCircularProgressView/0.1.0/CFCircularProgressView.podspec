...
Pod::Spec.new do |s|
  s.name             = 'CFCircularProgressView'
  s.version          = '0.1.0'
  s.summary          = 'Simple Circular Progress View'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
A Circular Progress View built for Camp Chef
                       DESC
  ...
  s.source           = { :git => 'https://github.com/Chris-Flammer/cf-circular-progress-view-ios.git', :tag => s.version.to_s }
